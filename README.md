...
A curated collection of algorithms and data structures implemented in Java. Some of the code is from [indy256](https://github.com/indy256/codelibrary) and the categorisation is based on [Sibyter](https://play.google.com/store/apps/details?id=com.izaron.pepperpied)
...
* [Combinatorics](https://github.com/pct960/Competitive_Programming/tree/master/src/Combinatorics)
  ...
  * [Enumeration of combinatorial sequences](https://github.com/pct960/Competitive_Programming/blob/master/src/Combinatorics/CombinatorialEnumerations.java)
  * [Enumeration of partitions](https://github.com/pct960/Competitive_Programming/blob/master/src/Combinatorics/Partitions.java)
  * [Enumeration of permutations](https://github.com/pct960/Competitive_Programming/blob/master/src/Combinatorics/Permutations.java)
  * [Random tree and graph generation using Prufer sequence](https://github.com/pct960/Competitive_Programming/blob/master/src/Combinatorics/RandomGraph.java)
...
* [Data Structures](https://github.com/pct960/Competitive_Programming/tree/master/src/Data_Structures)
  ...
  * [Hashmap with chains](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/ChainingHashMap.java)
  * [Cover Tree](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/CoverTree.java)
  * [Cover Tree Test](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/CoverTreeTest.java)
  * [Disjoint Set data structure](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/DisjointSets.java)
  * [Disjoint Set data structure with ranks](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/DisjointSetsRank.java)
  * [Doubly Linked List](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/DoublyLinkedList.java)
  * [Fenwick Tree 2D for sum](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/FenwickTree2D.java)
  * [Fenwick Tree 3D for sum](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/FenwickTree3D.java)
  * [Fenwick Tree for sum with extended operations](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/FenwickTreeExtended.java)
  * [Fenwick Tree for sum and maximum](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/FenwickTree.java)
  * [Heavy Light improved version](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/HeavyLight2.java)
  * [Heavy Light decomposition without recursion](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/HeavyLight2NoRecursion.java)
  * [Heavy Light tree decomposition for vertices or edges](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/HeavyLight.java)
  * [KdTree for nearest point query](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/KdTreePointQuery.java)
  * [KdTree for rectangular query](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/KdTreeRectQuery.java)
  * [Lowest Common Ancestor - Schieber and Vishkin algorithm](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/LcaSchieberVishkin.java)
  * [Link Cut Tree - Dynamic tree connectivity](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/LinkCutTreeConnectivity.java)
  * [Link Cut Tree - dynamic tree with path queries](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/LinkCutTree.java)
  * [Link Cut Tree - Dynamic tree LCA](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/LinkCutTreeLca.java)
  * [Mergeable Heap](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/MergeableHeap.java)
  * [Metric Tree for nearest point query](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/MetricTree.java)
  * [Mo's Algorithm second version](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/MosAlgorithm2.java)
  * [Mo's Algorithm for square root decomposition](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/MosAlgorithm.java)
  * [Persistent Tree](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/PersistentTree.java)
  * [Quad Tree for rectangular queries on NxM board](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/QuadTree.java)
  * [Queue with minimum query in O(1)](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/QueueMin.java)
  * [Range Minimum Query: Sparse Table](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/RmqSparseTable.java)
  * [RTree for nearest segment query](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/RTree.java)
  * [2D Segment Tree with single element modification](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/SegmentTree2D.java)
  * [Segment Tree second version](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/SegmentTree2.java)
  * [3D Segment Tree with single element modification](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/SegmentTree3D.java)
  * [Non Recursive Segment Tree - second version](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/SegmentTreeFast2.java)
  * [Non Recursive Segment Tree](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/SegmentTreeFast.java)
  * [Segment Tree for Add/Max - second version](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/SegmentTreeIntervalAddMax2.java)
  * [Segment Tree for Add/Max](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/SegmentTreeIntervalAddMax.java)
  * [Segment Tree with interval modification](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/SegmentTree.java)
  * [Segment Tree - Simple non recursive implementation](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/SegmentTreeSimple.java)
  * [Segment Tree with sum lower bound operation](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/SegmentTreeSumLowerBound.java)
  * [Treap with explicit keys](https://github.com/pct960/Competitive_Programming/blob/master/src/Data_Structures/TreapBST.java)
